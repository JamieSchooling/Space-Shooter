if (instance_exists(target))
{
	...
	if (!global.gamePaused) 
	{
		...
		x = clamp(x, camera_get_view_x(cam) + 30, camera_get_view_x(cam) + camera_get_view_width(cam) - 30);
		y = clamp(y, camera_get_view_y(cam) + 30, camera_get_view_y(cam) + camera_get_view_height(cam) - 30);
